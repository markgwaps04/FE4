 ...
 * @github.com\markgwaps04\OfDbSql
 */
...
class OfDbSql
{
    ...
    public $tempQuery = null;

    protected $guid = 0;

    public function __construct($options = null,bool $debugOnExecute = false)
    {

        $this->debugOnExecute = $debugOnExecute;
    ...
    public function exec($query, $map = [])
    {
        ...
        if ($this->debug_mode)
        {
            $result = $this->generate($query, $map);
        ...
        if ($statement)
        {
            ...
            if($this->debugOnExecute and $this->getErrors())
    ...
    {
        return ':OfDbSql' . $this->guid++ . '_OfDbSql';
    }
    ...
    public function ondelete($table, $unstrict = true , $where = [])
    {
        $map = [];
    ...
    public function debug(bool $print = false)
    {
        $this->debug_mode = true;

        $this->_debug_mode = $print;
